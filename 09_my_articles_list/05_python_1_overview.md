If you've done everything right, you should be able to see only articles that were created by the user you're logged in as when you access this page `127.0.0.1:8000/my-articles/`.
